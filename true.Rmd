...
data <- data[-1, ]
data <- data %>% select(-ALL)
sample=c(' g:Pelagicoccus', ' g:Puniceicoccus',' g:Spartobacteria_genera_incertae_sedis','g:Terrimicrobium','g:Xiphinematobacter','g:Limisphaera',"g:Subdivision3_genera_incertae_sedis",)
# Convert the data to numeric
data[, -1] <- sapply(data[, -1], as.numeric)
